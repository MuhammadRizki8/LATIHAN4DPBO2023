...
mhs1 = Mahasiswa('2107922', 'Andi', 'L', 'Teknik', 'Universitas Pendidikan Indonesia', 'andi@upi.edu')
mhs2 = Mahasiswa('2107923', 'Budi', 'L', 'Ekonomi', 'Universitas Pendidikan Indonesia', 'budi@upi.edu')
mhs3 = Mahasiswa('2107924', 'Cici', 'P', 'Psikologi', 'Universitas Pendidikan Indonesia', 'cici@upi.edu')
mhs4 = Mahasiswa('2107925', 'Dewi', 'P', 'Psikologi', 'Universitas Pendidikan Indonesia', 'dewi@upi.edu')


# membuat beberapa objek dosen
dsn1 = Dosen('001', '123', 'Dr. Ahmad', 'L', 'Teknik', 'S3', 'Artificial Intelligence', 'Universitas Pendidikan Indonesia', 'ahmad@upi.edu')
dsn2 = Dosen('002', '456', 'Dr. Roni', 'L', 'Ekonomi', 'S2', 'Ekonomi Pembangunan', 'Universitas Pendidikan Indonesia', 'budi@upi.edu')
dsn3 = Dosen('003', '789', 'Prof. Nana', 'P', 'Psikologi', 'S3', 'Psikologi Anak', 'Universitas Pendidikan Indonesia', 'cici@upi.edu')


# membuat beberapa objek course
course1 = Course('Pemrograman Python', dsn1)
...
prodi1 = ProgramStudi('Teknik Informatika', 'TI')
...
for prodi in [prodi1, prodi2, prodi3]:
    print("---------------------------------------")
    print(f'- Nama: {prodi.get_nama_prodi()}\n  Kode: {prodi.get_kode()}\n  Jumlah Course: {len(prodi.get_courses())}\n  Jumlah Mahasiswa: {sum([len(course.get_mahasiswa()) for course in prodi.get_courses()])}')
